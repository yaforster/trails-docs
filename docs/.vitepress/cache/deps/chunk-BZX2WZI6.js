...
var LITERAL_TEXT_CLOSE = function() {
  ...
  arrayForEach(LITERAL_TEXT_ELEMENT_NAMES, (name) => {
    map4[name] = seal(new RegExp("</" + name + "(?=[\\t\\n\\f\\r />])", "i"));
  });
  return freeze(map4);
}();
...
function createDOMPurify() {
  ...
  const _forkSharedAllowlist = function _forkSharedAllowlist2(hookList, set3, defaultSet, setConfigSet) {
    if (hookList.length === 0) {
      return set3;
    }
    return set3 === defaultSet || set3 === setConfigSet ? clone(set3) : set3;
  };
...
var renderKatex = __name(async (text2, config2) => {
  ...
  const { default: katex } = await import("./katex-DNPTKRDU.js");
...
*/
//# sourceMappingURL=chunk-BZX2WZI6.js.map
